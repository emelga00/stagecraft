...
public class Controller extends HttpServlet {
	...
	public void init(){
		...
		//--------------Projects---------------------
		requests.add(new RequestEntry("/Explore", "Forward", new Project_ViewAll(), "public", ""));
		requests.add(new RequestEntry("/Create","Forward",new Project_Add(),"public", "")); //"user,admin"
	}
